package se.skl.skltpservices.pingforconfiguration.pfcadaptercomponent.pfcadapterservice;
...
public class PFCAdapterServiceResponseTransformer extends AbstractMessageTransformer {

	private static final Logger log = LoggerFactory.getLogger(PFCAdapterServiceResponseTransformer.class);
