...
public class PFCAdapterServiceRequestTransformer extends AbstractMessageTransformer {

	private static final Logger log = LoggerFactory.getLogger(PFCAdapterServiceRequestTransformer.class);
